        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="rounded-2xl border p-5 mb-6" style={{ background: 'rgba(55,138,221,0.06)', borderColor: 'rgba(55,138,221,0.18)' }}>
            <div className="flex items-center justify-between mb-3">
              <p className="text-sm font-semibold text-gray-800 dark:text-white">Heute verdient</p>
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={label} className="flex items-center justify-between text-xs">
                  ...
                  <span className={done ? 'font-semibold' : 'text-gray-400 dark:text-white/40'} style={done ? { color } : undefined}>
          ...
          <div className="flex flex-col items-center justify-center text-center py-12">
            <div
              ...
              style={{ background: 'rgba(55,138,221,0.09)' }}
            >
